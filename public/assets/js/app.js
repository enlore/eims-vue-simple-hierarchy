...
var Hello = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('img',{attrs:{"src":"assets/images/logo.png"}}),_c('h1',[_vm._v(_vm._s(_vm.msg))]),_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.spoken),expression:"spoken"}],on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.spoken=$event.target.multiple ? $$selectedVal : $$selectedVal[0];}}},[_c('option',[_vm._v("One")]),_c('option',[_vm._v("Two Thre Four")]),_c('option',[_vm._v("Barking at the Freaky Door")]),_c('option',[_vm._v("What's in There?")])]),_c('button',{on:{"click":function($event){_vm.speak(_vm.spoken);}}},[_vm._v("Speaker")])])},staticRenderFns: [],_scopeId: 'data-v-361a4bd2',
  data: function data () {
    return {
...
var App = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"app"},[_c('Hello'),_c('tree-view',{staticStyle:{"margin-top":"16px"},attrs:{"data":_vm.nodes}})],1)},staticRenderFns: [],
    ...
    components: { Hello: Hello, TreeView: TreeView }
};
